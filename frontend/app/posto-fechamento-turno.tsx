...
const styles = StyleSheet.create({
  ...
  card: { ...WEB_FILTER_CARD, gap: spacing.sm, maxWidth: 640 },
  cardWeb: {},
  ...
  primaryBtn: { backgroundColor: colors.brandPrimary, borderRadius: radius.pill, paddingVertical: 12, paddingHorizontal: spacing.xl, alignSelf: "flex-start", alignItems: "center", marginTop: spacing.lg },
